// The single place every icon's SVG path data lives. Anything that needs an
// icon calls icon(name, opts) — nothing should hand-copy an SVG string, so
// the same concept can never end up drawn two different ways.
const ICON_PATHS = {
